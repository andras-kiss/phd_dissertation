...
\begin{axis}    [
		...
		\draw (axis cs:975,-87) -- (axis cs:1050,-87);
		\draw (axis cs:0,-115.5) -- (axis cs:1050,-115.5);
		\draw (axis cs:0,-116.4) -- (axis cs:1200,-116.4);
		\draw[{latex[scale=5.0]}-{latex[scale=5.0]}] (axis cs:975,-87) -- (axis cs:975,-116.4);
		\draw (axis cs:1050,-82) node[above] {$\tau_{95}$} -- (axis cs:1050,-130);
