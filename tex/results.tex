...
\subsubsection{Investigation of surface processes}
...
\addplot [domain=0:750, color=red, mark=*] table {data/stirring/stirring2.txt};
...
In another experiment, a filter was applied to decrease noise, but, as an RC filter, it added a time constant of its own to the measurement, and thus cannot be evaluated.
...
However, an electric field is also formed as a result of the potential difference between the surfaces of the galvanic pair, which has a direct influence on the potential of the sensing microelectrode, as it is depicted in Fig. \ref{fig:field}. The measured potential is the sum of these two contributions:
...
In this section, I present experimental evidence of this feature, and investigate the extent to which it influences the final chemically-resolved image.
