...
\begin{figure}
\begin{tikzpicture}
\begin{axis}[xmin=-0.5, xmax=5.5, width=7cm,height=6cm,xlabel=pMg, ylabel={E vs. Ag/AgCl/3 M KCl, mV}, clip marker paths=true,xtick distance=1, ytick distance=20, xminorticks=true, minor x tick num = 1]
...
\hfill
\begin{tikzpicture}
\begin{axis}[xmin=-0.5, xmax=5.5, width=7cm,height=6cm,xlabel=pMg, ylabel={E vs. Ag/AgCl/3 M KCl, mV}, clip marker paths=true,xtick distance=1, ytick distance=30, xminorticks=true, minor x tick num = 1]
...
\centering
\begin{tikzpicture}
\begin{axis}[xmin=-50, xmax=100, width=12cm,height=6cm,xlabel=Time / s, ylabel=E vs. Ag/AgCl/3 M KCl \, mV, clip marker paths=true]
\addplot [domain=-50:100, color=gray, mark=*] table {data/transient_aligned.txt};
\addplot [domain=-0.1:100, samples=500, color=red, line width=0.4mm] {-280.2+(280.2-183)*exp(-(x)/3.76)};
...
\centering
\begin{tikzpicture}
\begin{axis}[xmin=-1000, xmax=1000, width=6cm,height=6cm,xlabel=x / $\upmu$m, ylabel=E / V]
...
\centering
\begin{tikzpicture}
\begin{axis}[xmin=-1000, xmax=1000, width=6cm,height=6cm,xlabel=x / $\upmu$m, ylabel=pMg, y dir = reverse]
