...
%\centering
%\begin{tikzpicture}
%	\begin{axis}[width=5cm,height=5cm,view={0}{90},unit vector ratio*=1 1 1, colormap/thermal,xlabel=x / $\upmu$m, ylabel=y / $\upmu$m, mesh/rows=21, mesh/cols=21, mesh/ordering=y varies]
%	\addplot3[
%		surf,
...
%		set dgrid3d 21,21,1 spline;
%		%set pm3d interpolate 4,4;
%	        splot 'img/sim/meander_sim.txt';       
%	};
%
%	\end{axis}
%\end{tikzpicture}
