...
\hfill
\begin{tikzpicture}
\begin{axis}[xmin=-0.5, xmax=5.5, width=7cm,height=6cm,xlabel=pMg, ylabel={E vs. Ag/AgCl/3 M KCl, mV}, clip marker paths=true,xtick = {1,2,3,4,5}, ytick={-150,-120,-90,-60,-30,0}, xminorticks=true, minor x tick num = 1]
...
{\graphicspath{{img/mg_pipette/}} \input{img/mg_pipette/liquid_Mg.tex}}\hfill{\graphicspath{{img/mg_pipette/}} \input{img/mg_pipette/solid_Mg.tex}} 
\caption[SECM_ images displaying the Mg$^{2+}$ ion concentrations 100 $\upmu$m above the tip of a centered pipette source.]{SECM images displaying the Mg$^{2+}$ ion concentrations 100 $\upmu$m above the tip of a centered pipette source.
(A) liquid-contact, and (B) solid-contact.
...
{\graphicspath{{img/mg_metal/}} \input{img/mg_metal/liquid_uncoupled.tex}}\hspace{2cm}{\graphicspath{{img/mg_metal/}} \input{img/mg_metal/solid_uncoupled.tex}}\vspace*{-1cm}
{\graphicspath{{img/mg_metal/}} \input{img/mg_metal/liquid_coupled.tex}}\hspace{2cm}{\graphicspath{{img/mg_metal/}} \input{img/mg_metal/solid_coupled.tex}}
