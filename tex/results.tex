...
First, the shape of the fitted curve does not follow the measured curve perfectly.
...
This indicates that the process cannot be properly described by simple potentiometric step response function.
