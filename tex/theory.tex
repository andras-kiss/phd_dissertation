...
Unfortunalety, as with any other technique, the measurement itself influences the measured system, and therefore the measured value.
...
If the capacitance of the element constituted by these two plates changes -- by objects moving around in the envrionment, or charge transfer occuring -- small current will flow through the cable.
...
This effect can be minimised by using shielded cables to decrease stray capacitance, and using as short connections between high the impedance elements and the amplifier as possible.
